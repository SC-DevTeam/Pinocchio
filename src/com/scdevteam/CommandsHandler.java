...
public class CommandsHandler {
    ...
    public static BaseCommand getCommand(String cmd) {
        ...
        switch (parts[0]) {
			...
			{
                if (parts.length < 3) {
                    return new MissingParams("Usage: patch [cr - coc - bb - hh - bs] [host] [public key optional]");
                }
				
                String key = parts.length > 3 ? parts[3] : "72f1a4a4c48e44da0c42310f800e96624e6dc6a641a9d41c3b5039d8dfadc27e";
