...
public class WriterUtils {
    ...
    public static String buildGreenBold(String msg) {
        return GREEN_BOLD + msg + RESET;
    }

    public static String buildRedBold(String msg) {
        return RED_BOLD + msg + RESET;
    }

    public static String buildPurpleBold(String msg) {
        return PURPLE_BOLD + msg + RESET;
    }

    public static String buildCyanBold(String msg) {
        return CYAN_BOLD + msg + RESET;
    }

    public static String buildYellowBold(String msg) {
